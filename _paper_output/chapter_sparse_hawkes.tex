...
chosen \emph{a priori}.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_18_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
test the efficacy of the proposed method.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_34_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_34_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_34_2.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\texttt{\color{outcolor}Out[{\color{outcolor}7}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_36_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\texttt{\color{outcolor}Out[{\color{outcolor}8}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_38_0.png}
    \end{center}
    { \hspace*{\fill} \\}
