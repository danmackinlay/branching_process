...
chosen \emph{a priori}.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_14_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
test the efficacy of the proposed method.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_30_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_30_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_30_2.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\texttt{\color{outcolor}Out[{\color{outcolor}27}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_32_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\texttt{\color{outcolor}Out[{\color{outcolor}28}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{chapter_sparse_hawkes_files/chapter_sparse_hawkes_34_0.png}
    \end{center}
    { \hspace*{\fill} \\}
