...
from ipypublish.filters.filters import remove_dollars, \
    first_para, create_key, dict_to_kwds, is_equation
...
all_tplx_dicts = [p.tplx_dict for p in[
    package, doc, title, bib, output, code
]] + [defs_plus]
...
config = {
    'TemplateExporter.filters': _filters,
    'Exporter.filters': _filters,
    'Exporter.preprocessors': [
        MetaDefaults, SplitOutputs, LatexDocLinks, LatexCaptions
    ],
